...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Nav Item - Dashboard -->
      <li  <?php if(Request::is('dashboard')){ echo "class='nav-item active'";}else{echo "class='nav-item'";} ?> >
        <a class="nav-link" href="{{ url('dashboard') }}">
          <i class="fas fa-fw fa-tachometer-alt"></i>
          <span>Dashboard</span></a>
      </li>
      <li  <?php if(Request::is('manage-products')){ echo "class='nav-item active'";}else{echo "class='nav-item'";} ?> >
        <a class="nav-link" href="{{ url('manage-products') }}">
          <i class="fas fa-fw fa-folder"></i>
          <span>Manage Products</span></a>
      </li>
       <li <?php if(Request::is('api-details')){ echo "class='nav-item active'";}else{echo "class='nav-item'";} ?> >
        <a class="nav-link" href="{{ url('api-details') }}" >
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Copyright &copy; Product Manager 2020</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
